...
const TENANT_SLUG = 'sun-real-estate'

export const SREMedia: CollectionConfig = {
  slug: 'sre-media',
  upload: {
    staticDir: '../public/media/sre-media',
...
export const SREPages: CollectionConfig = {
  slug: 'sre-pages',
  admin: {
    group: GROUP,
    useAsTitle: 'title',
    ...
    preview: (doc) => {
      ...
      return `${domain}/preview?slug=${doc.slug}&collection=sre-pages`
    },
  },
  access: collectionAccess(TENANT_SLUG),
  fields: [
...
export const SREProjects: CollectionConfig = {
  slug: 'sre-projects',
  admin: {
    group: GROUP,
    useAsTitle: 'title',
    ...
    preview: (doc) => {
      const domain = process.env.PAYLOAD_PUBLIC_SERVER_URL || 'http://localhost:3000'
      return `${domain}/preview?slug=${doc.slug}&collection=sre-projects`
    },
  },
  access: collectionAccess(TENANT_SLUG),
  fields: [
    ...
    },
    {
      ...
      fields: [
        { name: 'image', type: 'upload', relationTo: 'sre-media' },
...
export const SREServices: CollectionConfig = {
  slug: 'sre-services',
  admin: {
    group: GROUP,
    useAsTitle: 'title',
...
export const SRETeam: CollectionConfig = {
  slug: 'sre-team',
  admin: {
    group: GROUP,
    useAsTitle: 'name',
...
export const SRETestimonials: CollectionConfig = {
  slug: 'sre-testimonials',
  admin: {
    group: GROUP,
...
export const SREBlog: CollectionConfig = {
  slug: 'sre-blog',
  admin: {
    group: GROUP,
    useAsTitle: 'title',
    ...
    preview: (doc) => {
      const domain = process.env.PAYLOAD_PUBLIC_SERVER_URL || 'http://localhost:3000'
      return `${domain}/preview?slug=${doc.slug}&collection=sre-blog`
    },
  },
  access: collectionAccess(TENANT_SLUG),
  fields: [
...
export const SRESettings: CollectionConfig = {
  slug: 'sre-settings',
  admin: {
    group: GROUP,
    useAsTitle: 'siteName',
