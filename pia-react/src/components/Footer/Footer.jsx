            ...
            <div className="single-footer-widget marbtm50">
              <div className="contact-info-box">
                <div className="footer-logo">
                  <Link to="/">
                    <img src="/images/resources/logo.png" alt="PIA Logo" style={{ width: 'auto', height: '100px' }} />
                  </Link>
                </div>
                <ul>
                  <li>
          ...
          <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
            <div className="single-footer-widget marbtm50">
              ...
              <div className="services-links">
                <ul>
                  <li><Link to="/services/concept-designs">Interior Design</Link></li>
                  <li><Link to="/services/project-designs">Exterior Design</Link></li>
                  <li><Link to="/services/make-overs">Home Renovation</Link></li>
